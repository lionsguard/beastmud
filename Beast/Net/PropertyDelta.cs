...
namespace Beast.Net
{
	public class PropertyDelta : DeltaMessage
	{
		...
		/// <returns>A new PropertyDelta instance.</returns>
		public static PropertyDelta Create<TObject, TProperty>(TObject obj, Expression<Func<TObject, TProperty>> expression) where TObject : GameObject
		{
		...
		/// <returns>A new PropertyDelta instance.</returns>
		public static PropertyDelta Create<TObject>(TObject obj, string propertyName) where TObject : GameObject
		{
			return new PropertyDelta
			       	{
			       		ObjectId = obj.Id,
